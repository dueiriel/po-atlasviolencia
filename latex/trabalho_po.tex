...
Anuário FBSP 2023 & Mortes violentas por UF & 2021-2022 & forumseguranca.org.br \\
...
Os cinco estados mais eficientes são: São Paulo (2,82), Distrito Federal (2,37), Maranhão (2,37), Piauí (2,09) e Santa Catarina (1,87). Estes estados conseguem taxas de violência abaixo ou próximas da média com gastos abaixo da média nacional.

Os cinco menos eficientes são: Tocantins (0,43), Amapá (0,44), Rondônia (0,50), Roraima (0,54) e Mato Grosso (0,56). Estes estados gastam muito acima da média (R\$ 1.000+/capita) mas mantêm taxas de violência acima de 90 por 100 mil habitantes.
...
Primeiro, a eficiência no uso de recursos de segurança varia significativamente entre os estados brasileiros. Utilizando a fórmula de eficiência com pesos (75\% resultado + 25\% economia), estados como São Paulo e Santa Catarina lideram o ranking, conseguindo baixas taxas de violência com gastos moderados.
...
\begin{itemize}
    ...
    \item Os dados de gastos do SICONFI (2013-2023) podem ter inconsistências entre estados devido a diferentes metodologias contábeis;
    \item O modelo assume linearidade, que pode não valer para investimentos muito grandes (retornos decrescentes);
    \item Fatores externos (legislação, economia, demografia) não são capturados pelo modelo.
\end{itemize}
