...
\begin{titlepage}
    ...
    % Instituição
    {\normalsize\MakeUppercase{Universidade}}\\
    {\normalsize\MakeUppercase{Departamento de Engenharia / Ciência da Computação}}\\
...
O modelo foi implementado em Python utilizando a biblioteca PuLP com o solver CBC (Coin-or Branch and Cut), que é open-source e eficiente para problemas de médio porte.
